      ...
      <Container className="py-14 sm:py-16 lg:py-[4.75rem]">
        <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-12 xl:gap-16">
          <div className="lg:col-span-6">
            ...
            <h1
              id="hero-heading"
              className="mt-4 hyphens-none font-serif text-[2.35rem] font-semibold leading-[1.08] tracking-[-0.02em] text-ivory [text-wrap:pretty] sm:text-5xl lg:max-w-none lg:text-[2.7rem] xl:text-[3.05rem]"
            >
              <span className="lg:whitespace-nowrap">Polsterei & Sattlerei</span>
