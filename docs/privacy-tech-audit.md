...
Local/dev without SMTP/Turnstile keys uses console mail and Turnstile bypass. Hosted Vercel production fails closed without those credentials. Rate limiting uses in-process memory in all environments.
